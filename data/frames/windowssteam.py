#!/usr/bin/env python3
"""
Linux Gaming Center - Windows/Steam Frame
Windows/Steam Game library similar to Apps library
"""
...
class WindowsSteamFrame:
    def __init__(self, parent, theme, scaler, username=None):
        ...
        # Base directory for Windows/Steam games (shared across all users)
        data_base = get_data_base_path()
        self.games_base_dir = data_base / "windowssteam"
        ...
        if username:
            ...
            self.recently_used_file = self.user_account_dir / "recently_used_windowssteam.json"
        else:
            ...
            if config_file.exists():
                try:
                    with open(config_file, 'r') as f:
                        config = json.load(f)
                    show_add_button = config.get("show_add_button_windowssteam", True)
                except:
                    pass
    ...
    def show_add_game_popup(self):
        ...
        popup.title("Add New Windows/Steam Game")
        ...
        title_label = tk.Label(
            popup,
            text="Add New Windows/Steam Game",
            font=heading_font,
            bg=bg_color,
            fg=text_color
        )
    ...
    def load_games(self):
        ...
        if not games:
            ...
            empty_label = tk.Label(
                ...
                text="No games added yet.\nClick '+ Add Windows/Steam Game' to get started.",
